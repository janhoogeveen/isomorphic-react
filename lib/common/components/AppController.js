...
function getOverallNavigation() {
  return [{ name: 'app' }, { name: 'home' }, { name: 'about' }, { name: 'work' }, { name: 'work-index' }, {
    name: 'project',
    params: {
      id: 1
    }
...
var AppController = (function (_React$Component) {
  ...
  _createClass(AppController, [{
    ...
    value: function render() {
      ...
      var navItems = this.state.navItems.map(function (navItem) {
        return _react2['default'].createElement(
          'li',
          { key: navItem.name },
          _react2['default'].createElement(
            _reactRouter.Link,
            { to: navItem.name, params: navItem.params },
            navItem.name
          )
        );
      });
      ...
      return _react2['default'].createElement(
        'div',
        { className: _stylesCss2['default'].app },
        _react2['default'].createElement(
          'p',
          null,
          'This should become a sidebar with navigation'
        ),
        _react2['default'].createElement(
          'ul',
